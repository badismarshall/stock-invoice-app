...
- add another section for only facture proforma
...
- ~~fix Montant totale on /dashboard/export/proforma~~
~~==- In /dashboard/export/proforma le montant totale must use the currency selected when creating the facture.==~~
- ~~in /dashboard/export/proforma/new we must delete the cach so when navigate away and go back we must show an empty form.~~
- ~~modify the export in action bar of /dashboard/products/unit-of-measure~~
- ~~modify the export in action bar of /dashboard/products/category~~
- ~~modify the export in action bar of /dashboard/clients-suppliers/suppliers~~
- ~~modify the export in action bar of /dashboard/clients-suppliers~~
- ~~in /dashboard/invoices we need to show only the facture vente detail and export (not purchase and proforma)~~
- ~~in /dashboard/invoices/new add currency, delete the proforma from the type~~
- verify the purchase modify tva and prix unitatire lagging
- ~~changing the curency in the table of purchases when modify the curency of the new purchase~~
- 
## Informations
 - Nodejs v24
