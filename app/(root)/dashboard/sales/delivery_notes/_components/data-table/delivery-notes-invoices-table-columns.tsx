...
interface GetDeliveryNotesInvoicesTableColumnsProps {
...
const translations = {
  invoiceNumber: "N° Bon de Livraison",
...
export function getDeliveryNotesInvoicesTableColumns({
  setRowAction,
  clients = [],
}: GetDeliveryNotesInvoicesTableColumnsProps): ColumnDef<InvoiceDTOItem>[] {
  return [
    {
      id: "select",
      header: ({ table }) => (
