...
import { ExportPurchasesPDFContent } from "./_components/export-purchases-pdf-content"
import type { SearchParams } from "@/types"

export const metadata: Metadata = {
    title: "Export PDF - Achats",
    description: "Export de toutes les commandes d'achat en PDF",
}

interface ExportPurchasesPDFPageProps {
  searchParams: Promise<SearchParams>;
}

export default async function ExportPurchasesPDFPage(props: ExportPurchasesPDFPageProps) {
