...
interface PurchaseInvoicesTableActionBarProps {
  table: Table<InvoiceDTOItem>;
}

export function PurchaseInvoicesTableActionBar({ table }: PurchaseInvoicesTableActionBarProps) {
  ...
  return (
    <DataTableActionBar table={table} visible={rows.length > 0}>
      ...
      <div className="flex items-center gap-1.5">
        <DataTableActionBarAction
          size="icon"
          tooltip="Exporter les factures d'achat"
