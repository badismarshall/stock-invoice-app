...
interface GetPurchaseInvoicesTableColumnsProps {
...
export function getPurchaseInvoicesTableColumns({
  setRowAction,
  suppliers = [],
}: GetPurchaseInvoicesTableColumnsProps): ColumnDef<InvoiceDTOItem>[] {
  return [
    {
      id: "select",
      header: ({ table }) => (
