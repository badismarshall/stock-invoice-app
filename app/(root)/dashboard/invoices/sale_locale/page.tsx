...
export const metadata: Metadata = {
    ...
    description: "Gestion des factures de vente locale",
}
    ...
    return (
      <div className="h-full flex-1 flex-col space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Factures de vente locale</h2>
            <p className="text-muted-foreground">
              Gérez toutes vos factures de vente locale ici!
            </p>
          </div>
        ...
        <Suspense 
            ...
            />
              ...
              <FeatureFlagsProvider>
                <InvoicesTableWrapper {...props} invoiceTypeFilter={["sale_local"]} />
              </FeatureFlagsProvider>
        </Suspense>
      </div>
    )
