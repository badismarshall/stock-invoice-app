...
export function ExportStockButtons() {
  ...
  const handleExportPDF = React.useCallback(async () => {
    ...
    try {
      ...
      // Get filtered stock
      const { getFilteredStockForExport } = await import("../../_lib/export-actions");
  ...
  const handleExportXLSX = React.useCallback(async () => {
    ...
    try {
      ...
      const stockResult = await getFilteredStockForExport({
        ...search,
        filters: validFilters,
      });
