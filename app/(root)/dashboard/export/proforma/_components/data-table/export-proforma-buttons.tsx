...
import { getFilteredProformaInvoicesForExport } from "../../_lib/export-actions";
...
export function ExportProformaButtons() {
  ...
  const handleExportPDF = React.useCallback(async () => {
    ...
    try {
      ...
      const [invoicesResult, companyResult] = await Promise.all([
        getFilteredProformaInvoicesForExport({
          ...search,
  ...
  const handleExportXLSX = React.useCallback(async () => {
    ...
    try {
      ...
      const invoicesResult = await getFilteredProformaInvoicesForExport({
        ...search,
        filters: validFilters,
      });
