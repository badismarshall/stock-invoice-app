...
export function NewProformaInvoiceForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Échec de la création de la facture proforma",
        {
          position: "bottom-center",
          duration: 3000,
        }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Nouvelle Facture Proforma</h1>
            <p className="text-muted-foreground">Création d'une facture proforma pour vente export</p>
          </div>
        </div>
      </div>
