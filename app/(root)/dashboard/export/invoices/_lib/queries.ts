...
import type { GetExportInvoicesSchema } from "./validation";
...
export async function getExportInvoices(input: GetExportInvoicesSchema) {
  ...
  try {
    ...
    // Force invoiceType to only include sale_export
    ...
    console.error("Error in getExportInvoices service", error);
