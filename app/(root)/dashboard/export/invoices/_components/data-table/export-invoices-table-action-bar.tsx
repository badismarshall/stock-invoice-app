...
interface ExportInvoicesTableActionBarProps {
  table: Table<InvoiceDTOItem>;
}

export function ExportInvoicesTableActionBar({ table }: ExportInvoicesTableActionBarProps) {
  ...
  return (
    <DataTableActionBar table={table} visible={rows.length > 0}>
      ...
      <div className="flex items-center gap-1.5">
        <DataTableActionBarAction
          size="icon"
          tooltip="Exporter les factures export"
