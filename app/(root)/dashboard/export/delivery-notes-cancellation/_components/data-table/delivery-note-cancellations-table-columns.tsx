        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-40">
              <DropdownMenuItem
                onSelect={() => router.push(`/dashboard/export/delivery-notes-cancellation/print/${cancellation.id}`)}
              >
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem
                onSelect={() => router.push(`/dashboard/export/delivery-notes-cancellation/modify/${cancellation.id}`)}
              >
                {translations.edit}
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
                onSelect={() => router.push(`/dashboard/export/delivery-notes-cancellation/delete/${cancellation.id}`)}
