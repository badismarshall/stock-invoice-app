...
import { getDeliveryNoteCancellationByIdAction } from "@/app/(root)/dashboard/export/delivery-notes-cancellation/_lib/actions";
import { DeleteCancellationForm } from "./_components/delete-cancellation-form";

export const metadata: Metadata = {
  title: "Supprimer Annulation de Bon de Livraison Export",
  description: "Supprimer une annulation de bon de livraison d'export",
};
