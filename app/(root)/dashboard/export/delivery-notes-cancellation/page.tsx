...
export const metadata: Metadata = {
    title: "Annulations de Bons de Livraison Export",
    description: "Liste des annulations de bons de livraison d'export",
}
    ...
    return (
      <div className="h-full flex-1 flex-col space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Annulations de Bons de Livraison Export</h2>
            <p className="text-muted-foreground">
              Liste de toutes les annulations de bons de livraison d'export
            </p>
          </div>
          <Link href="/dashboard/export/delivery-notes-cancellation/new">
            <Button>
