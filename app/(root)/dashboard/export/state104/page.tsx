...
export const metadata: Metadata = {
  title: "Etat 104 - Export",
  description: "Etat 104 - Totale TVA par client (ventes export)",
};
  ...
  return (
    <div className="h-full flex-1 flex-col space-y-8">
      <div className="flex items-center justify-between space-y-2">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Etat 104 - Export</h2>
          <p className="text-muted-foreground">
            Totale TVA par client (ventes export) sur la période et les clients sélectionnés
          </p>
        </div>
      </div>
      <Suspense
