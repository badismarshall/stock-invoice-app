...
interface StatsTableProps {
  title: string;
  description: string;
  data: ExportSalesStats["byClient"] | ExportSalesStats["byProduct"];
  type: "client" | "product";
}
      ...
      <CardContent>
        <Table>
          ...
          <TableBody>
            {data.map((item, index) => {
              if (type === "client") {
                const clientItem = item as ExportSalesStats["byClient"][0];
                return (
                ...
                const productItem = item as ExportSalesStats["byProduct"][0];
                return (
