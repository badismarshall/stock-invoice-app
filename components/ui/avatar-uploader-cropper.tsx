...
export default function AvatarUploaderCropper({ defaultImageUrl }: { defaultImageUrl: string | null }) {
  const [
    { files, isDragging },
    {
      handleDragEnter,
  ...
  const [finalImageUrl, setFinalImageUrl] = useState<string | null>(defaultImageUrl)
