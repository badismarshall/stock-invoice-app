...
// Le code original reste inchangé sauf pour les chaînes de caractères visibles à l'utilisateur, traduites en français.
        ...
        <CommandGroup>
          ...
          >
            {isEmpty ? (
              <>
                <Text />
                <span>Tapez pour ajouter un filtre...</span>
              </>
            ) : (
              <>
                <BadgeCheck />
  ...
  if (filter.operator === "isEmpty" || filter.operator === "isNotEmpty") {
    return (
      <div
        id={inputId}
        role="status"
        aria-label={`${column.columnDef.meta?.label} le filtre est ${
          filter.operator === "isEmpty" ? "vide" : "non vide"
        }`}
        aria-live="polite"
    ...
    case "range": {
      ...
      return (
        <Input
          ...
          placeholder={column.columnDef.meta?.placeholder ?? "Entrer une valeur..."}
    ...
    case "boolean": {
      ...
      return (
        ...
        >
          ...
          >
            <SelectValue placeholder={filter.value ? "Vrai" : "Faux"} />
          </SelectTrigger>
    ...
    case "multiSelect": {
      ...
      return (
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          ...
          >
            <Command>
              <CommandInput placeholder="Rechercher des options..." />
              <CommandList>
                <CommandEmpty>Aucune option trouvée.</CommandEmpty>
                <CommandGroup>
                  {options.map((option) => (
